...
public class SelectModeFragment extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
		...
		updateModeView();
		//when start,set content to invisible and wait for animation
		contentContainer_.setVisibility(View.INVISIBLE);
		return mainView_;
	}
	...
	public void onStart() {
		super.onStart();
		if(startWithAnimation_) {
			startWithAnimation_ = false;
			startStartAnimation();		
		} else {
